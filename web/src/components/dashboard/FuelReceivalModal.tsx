...
import { createFuelReceival } from '../../lib/api'
...
export function FuelReceivalModal({ onBack, onClose, isEditing, initialTankId }: Props) {
  ...
  const defaultTank = tanks.find((t) => t.id === initialTankId) ?? tanks[0]
