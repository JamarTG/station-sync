...
INSERT INTO users (id, name, role, password_hash, active, phone, nis, trn, email) VALUES
  ('f60f593a-28d2-4c17-9cd5-02c42c692574', 'John Smith', 'Supervisor', 'hash1', true, '555-0001', 'NIS001', 'TRN001', 'john@example.com'),
  ('d99f5df6-8733-4ebd-ab7e-3e7ff9fea903', 'Jane Doe',   'Attendant',  'hash2', true, '555-0002', 'NIS002', 'TRN002', 'jane@example.com');
