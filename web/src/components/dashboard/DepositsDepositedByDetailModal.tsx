...
export function DepositsDepositedByDetailModal({ depositedBy, entries, onBack, onClose }: Props) {
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-[36px] font-bold text-[#111] leading-none">{depositedBy}</h2>
