...
type User struct {
	...
	ReactivateOn         *string  `db:"reactivate_on" json:"reactivate_on"`
	DeactivationNote     *string  `db:"deactivation_note" json:"deactivation_note"`
	SickDaysUsed         *int     `db:"sick_days_used" json:"sick_days_used,omitempty"`
